...
const POSITION_PROMPT = str.newline(
  ...
  "2. **open_price**: цена входа (текущая рыночная цена по стакану или close последней свечи).",
  "3. **stop_loss_price**: уровень стоп-лосса, обоснованный техническим анализом (поддержка/сопротивление, ATR).",
  "4. **take_profit_price**: уровень тейк-профита (ближайший значимый уровень Фибоначчи или сопротивление/поддержка).",
  "5. **reasoning**: кратко объясни почему именно эта точка входа, стоп и тейк.",
  "",
